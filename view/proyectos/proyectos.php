							...
							<table class="centered striped bordered z-depth-3">
						        ...
						        <tbody>
						          	<tr>
										...
										<br/><br/><a onclick="" href="../../controller/proyectos/borrarProyecto.php?idProyecto=<?php echo $rows['idProyecto'];?>" class="btn tooltipped red" data-position="bottom" data-delay="50" data-tooltip="Eliminar proyecto"><i class="material-icons">cancel</i></a></td>
						          	</tr>
									    <?php 
											}
									    ?>
