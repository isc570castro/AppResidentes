			...
			<div class="col m12">
			    <div class="card-panel white z-depth-3">
					...
					<div class="row">
					    <div class="col m12">
					      	<ul class="tabs">
					        <li class="tab col s3"><a class="active" href="#enProceso">En proceso</a></li>
					        <li class="tab col s3"><a href="#concluidos">Concluidos</a></li>
					        <li class="tab col s3"><a href="#cancelados">Cancelados</a></li>
					        <li class="tab col s3"><a href="#todos">Todos</a></li>
					      </ul>
					    </div>
					    <div class="row">
							<div class="col m12" id="enProceso">
								<table class="centered striped bordered z-depth-3">
							        ...
							        <tbody>
							          	<tr>
											...
											<td><a href="editar.php?idProyecto=<?php echo $rows['idProyecto'];?>" class="btn tooltipped blue" data-position="bottom" data-delay="50" data-tooltip="Editar proyecto"><i class="material-icons">edit</i></a>
											<br/><br/><a href="../../controller/proyectos/borrarProyecto.php?idProyecto=<?php echo $rows['idProyecto'];?>" class="btn tooltipped red" data-position="bottom" data-delay="50" data-tooltip="Eliminar proyecto" onclick="return elimProy();"><i class="material-icons">cancel</i></a></td>
							          	</tr>
										    <?php 
												}
										    ?>
							        ...
							        <tbody>
							          	<tr>
											<?php
												$objConex = new Conexion();
												$link=$objConex->conectarse();
												$sql = mysql_query("SELECT * FROM proyecto where estado='Concluido';" , $link) or die(mysql_error());
																				while ($rows = mysql_fetch_array($sql)){   
											?>
											<td><?php echo $rows ['nombreProyecto']; ?></td>
											<td><?php echo $rows ['asesorExterno']; ?></td>
						...
						<div class="row">
							<div class="col m12" id="cancelados">
								<table class="centered striped bordered z-depth-3">
							        <thead>
							          	<tr>
							              	<th>Nombre del proyecto</th>
							        ...
							        <tbody>
							          	<tr>
											<?php
												$objConex = new Conexion();
												$link=$objConex->conectarse();
												$sql = mysql_query("SELECT * FROM proyecto where estado='Cancelado';" , $link) or die(mysql_error());
																				while ($rows = mysql_fetch_array($sql)){   
											?>
											<td><?php echo $rows ['nombreProyecto']; ?></td>
											<td><?php echo $rows ['asesorExterno']; ?></td>
